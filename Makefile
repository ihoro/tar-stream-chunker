...
valgrind: clean
	...
	$(VALGRIND) ./$(P) -f file -s   10 < <(head -c 1000 /dev/random) > /dev/null
	$(VALGRIND) ./$(P) -f file -s  100 < <(head -c 1000 /dev/random) > /dev/null
	$(VALGRIND) ./$(P) -f file -s 1000 < <(head -c 1000 /dev/random) > /dev/null
